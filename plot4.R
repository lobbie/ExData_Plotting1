...
# Plot 4 - plot graphs and output png
dev.off()
par(mfcol=c(2,2), mar=c(4,4,2,1), oma=c(0,0,2,0))
with(dfPower, {
  plot(dfPower$Global_active_power~dfPower$datetime, type="l", 
  ...
  plot(dfPower$Voltage~dfPower$datetime, type="l", 
       xlab="DateTime", ylab="Voltage")
  
  plot(dfPower$Global_reactive_power~dfPower$datetime, type="l", 
